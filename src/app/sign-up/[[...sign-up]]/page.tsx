  ...
  return (
    <main className="min-h-screen bg-bone px-6 py-16 text-ink">
      <div className="mx-auto max-w-xl rounded-3xl border border-mud/20 bg-white p-8 shadow-soft">
        ...
        <h1 className="mt-3 text-3xl font-black">Clerk keys are needed to create an account.</h1>
        <p className="mt-4 text-ink/70">
          The HomeBiz Kids sign-up route is wired. Add your Clerk publishable and secret keys to
          the environment, then this page will show the hosted parent account sign-up form.
        </p>
